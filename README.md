...
```sh
docker build --build-arg PHP_VERSION=7.4.33-cli -t not-empty/simple-elasticsearch-php-lib:php74 -f contrib/Dockerfile .
```

Access the container
```sh
docker run -v ${PWD}/:/var/www/html -it not-empty/simple-elasticsearch-php-lib:php74 bash
```
